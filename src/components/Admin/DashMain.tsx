...
const DashMain = () => {
    ...
    const format = (nb: number | string, length: number = 2) => {
                ...
                !isLoading && starts ?
                    <div className="resume d-grid grid-4 gap-3 fw-bold mt-3">
                        <div className="r-card d-flex justify-content-center gap-3 border border-1 bg-secondary p-3">
                            <h1>{format(starts.data?.products || 0)}</h1>
                            <h4 className='align-self-center'>Total Products</h4>
                        </div>
                        <div className="r-card d-flex justify-content-center gap-3 border border-1 bg-secondary p-3">
                            <h1>{format(starts.data?.customers || 0)}</h1>
                        ...
                        <div className="r-card d-flex justify-content-center gap-3 border border-1 bg-secondary p-3">
                            <h1>{format(starts.data?.categories || 0)}</h1>
                            <h4 className='align-self-center'>Categories</h4>
                        </div>
                        <div className="r-card d-flex justify-content-center gap-3 border border-1 bg-secondary p-3">
                            <h1>{format(starts.data?.slides || 0)}</h1>
                        ...
                        <div className="r-card d-flex justify-content-center gap-3 border border-1 bg-secondary p-3">
                            <h1>{format(starts.data?.admins || 0)}</h1>
