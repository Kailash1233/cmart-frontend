...
const ViewSearch = ({ setShow }: { setShow: Function }) => {
  ...
  return (
    <>
      ...
      ></div>
      <div
        className="position-fixed fw-bold top-0 end-0 col-12 col-lg-3 p-3 bg-white h-100 text-black"
        style={{ zIndex: 2500 }}
      >
        <h4 className="fw-bold w-100">
          SEARCH{" "}
          <span className="float-end cursor-pointer" onClick={hideSearch}>
        ...
        <div className="overflow-auto">
          <div className="w-100 d-flex">
            ...
            <div className="w-25">
              <button className="btn-outline-none border-0 fd-bg-primary rounded-0 py-3 px-4 text-white">
                <i className="bi bi-search w-100"></i>
              </button>
            </div>
          </div>
        </div>
