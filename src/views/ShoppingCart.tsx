    ...
    <>
      ...
      <div className="px-3 px-lg-5 my-5">
              ...
              {shopping.length > 0 ? (
                ...
                <tr className="p-5">
                  <td className="fw-bold text-center" colSpan={6}>
                    You have not a product in shopping cart
                  </td>
                </tr>
              )}
            </tbody>
        ...
        <div className="my-4 d-flex justify-content-between">
          <div>
            <Link to={RoutePaths.shop} className="fd-btn">
              CONTINUE SHOPPING
            </Link>
          </div>
          <div>
            <Link to={RoutePaths.cart} className="fd-btn">
              UPDATE CART
            </Link>
          </div>
        </div>
          ...
          <div className="coupon-total row justify-content-between gap-2 text-dark">
            <div className="coupon col-12 col-lg-8 p-4 border border-1">
              ...
              <div className="my-3">
                <label className="w-100">
                  ...
                  <input
                    type="text"
                    className="w-100 form-control rounded-0 border"
                    placeholder="XXX"
                  />
                </label>
              </div>
              <div className="submit w-50 shadow">
                <a href="#" className="fd-btn text-center">
                  APPLY
                </a>
              </div>
            </div>
            <div className="total p-4 border border-1 col-12 col-lg-3">
              ...
              <div className="submit mt-3">
                <Link to={"/checkout"} className="fd-btn text-center">
                  PROCEED CHECKOUT
                </Link>
              </div>
            </div>
