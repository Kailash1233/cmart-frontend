...
const Shop = () => {
  ...
  const changeTypeToGrid = () => {
    setType("grid");
  };
  const changeTypeToList = () => {
    setType("list");
  };
          ...
          <div className="d-flex justify-content-between">
            <div>
              <span
                className={
                  type === "grid"
                    ? "me-2 cursor-pointer fd-color-primary"
                    : "me-2 cursor-pointer"
                }
                onClick={changeTypeToGrid}
              >
              ...
              <span
                className={
                  type === "list"
                    ? "me-2 cursor-pointer fd-color-primary"
                    : "d-none d-lg-block me-2 cursor-pointer"
                }
                onClick={changeTypeToList}
              >
                <i className="bi bi-list-task"></i>
              </span>
            </div>
            <h5 className="fw-bold d-none d-lg-block">
              Showing 1-17 of 18 Result
            </h5>
