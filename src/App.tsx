    ...
    <Routes>
      ...
      <Route element={<PrivateRoute type={0} />}>
        ...
        <Route
          ...
          element={<UserAccount currentComponent={<UserOrders />} />}
        ></Route>
        <Route
          path={RoutePaths.userAdress}
          element={<UserAccount currentComponent={<UserAddress />} />}
        ></Route>
        <Route
          path={RoutePaths.userDetails}
          element={<UserAccount currentComponent={<UserDetails />} />}
        ></Route>
      </Route>
      ...
      <Route element={<PrivateRoute type={1} />}>
        ...
        <Route
          ...
          element={<AdminPanel currentComponent={<ProductMain />} />}
        ></Route>
        <Route
          path={RoutePaths.adminSlides}
          element={<AdminPanel currentComponent={<SlidesMain />} />}
        ></Route>
        <Route
          path={RoutePaths.adminCategories}
          element={<AdminPanel currentComponent={<CategoryMain />} />}
        ></Route>
        <Route
          path={RoutePaths.adminBlog}
          element={<AdminPanel currentComponent={<BlogMain />} />}
        ></Route>
        <Route
          path={RoutePaths.adminCustomers}
          element={<AdminPanel currentComponent={<CustomersMain />} />}
        ></Route>
        <Route
